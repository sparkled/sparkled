...
class ExpoOutEasingTest {
    ...
    fun can_ease_0_to_100() {
        val easingFunction = ExpoOutEasing()
        val easing = Easing(EasingTypeCode.EXPO_OUT, 0f, 100f)
    ...
    fun can_ease_100_to_0() {
        val easingFunction = ExpoOutEasing()
        val easing = Easing(EasingTypeCode.EXPO_OUT, 100f, 0f)
    ...
    fun can_ease_20_to_80() {
        val easingFunction = ExpoOutEasing()
        val easing = Easing(EasingTypeCode.EXPO_OUT, 20f, 80f)
    ...
    fun can_ease_80_to_20() {
        val easing = Easing(EasingTypeCode.EXPO_OUT, 80f, 20f)
        val easingFunction = ExpoOutEasing()
