...
class SequenceValidator {
    ...
    private object Errors {
        internal const val NAME_MISSING = "Sequence name must not be empty."
        internal const val FRAMES_PER_SECOND_NOT_POSITIVE = "Sequence frames per second must be greater than 0."
    }
}
