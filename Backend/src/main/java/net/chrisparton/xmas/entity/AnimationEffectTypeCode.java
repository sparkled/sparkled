...
import net.chrisparton.xmas.renderer.effect.FlashEffectRenderer;
import net.chrisparton.xmas.renderer.effect.LineLeftEffectRenderer;
import net.chrisparton.xmas.renderer.effect.LineRightEffectRenderer;
